...
const CONFIG = {
  ...
  paths: {
    login: __ENV.LOGIN_PATH || "/api/users/login",
    me: __ENV.ME_PATH || "/api/users/me",
    productList: __ENV.PRODUCT_LIST_PATH || "/api/products",
    productDetail: __ENV.PRODUCT_DETAIL_PATH || "/api/products/{productId}",
    inventoryDetail: __ENV.INVENTORY_DETAIL_PATH || "/api/inventories/{productId}",
    orderCreate: __ENV.ORDER_CREATE_PATH || "/api/orders",
    orderDetail: __ENV.ORDER_DETAIL_PATH || "/api/orders/{orderNo}",
    orderCancel: __ENV.ORDER_CANCEL_PATH || "/api/orders/{orderNo}/cancel",
    paymentPay: __ENV.PAYMENT_PAY_PATH || "/api/payments/{orderNo}/pay",
    paymentDetail: __ENV.PAYMENT_DETAIL_PATH || "/api/payments/{orderNo}",
  },
};
